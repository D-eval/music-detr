...
def add_ddetrsvluni_config(cfg):
    ...
    # Keep the text decoder as small as possible to reduce VRAM usage.
    cfg.MODEL.TEXT.TEXT_DECODER = 'google/flan-t5-small' # hidden size 512
    ...
    cfg.MODEL.CLIP = CN()
    # Keep CLIP on the smallest common variant by default.
    cfg.MODEL.CLIP.NAME = "ViT-B/32" # embed dim 512
    cfg.MODEL.CLIP.EMBED_DIM = 512
