...
设置一个单独的特殊query作为before就行了
但是之后的任务中，before不一定只有一个，
所以大概还是不要这样投机取巧了吧。

# 4/18

今天训练 chord detr 的效果
![](./tiny_save/20260418/t0.png)
![](./tiny_save/20260418/t1.png)
![](./tiny_save/20260418/t2.png)

我觉得接下来就是多标数据，好像也没啥了。必须确保能识别到那些
